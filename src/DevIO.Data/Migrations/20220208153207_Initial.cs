        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    varchar200 = table.Column<string>(name: "varchar(200)", type: "varchar(100)", nullable: false),
                    varchar14 = table.Column<string>(name: "varchar(14)", type: "varchar(100)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FornecedorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    varchar200 = table.Column<string>(name: "varchar(200)", type: "varchar(100)", nullable: false),
                    varchar1000 = table.Column<string>(name: "varchar(1000)", type: "varchar(100)", nullable: false),
                    varchar100 = table.Column<string>(name: "varchar(100)", type: "varchar(100)", nullable: false),
